...
@section('title') Zero|CMS - {{__('_basic.setting-index')}} @stop
@section('content')

    @include('widgets.content-msgInfo')
    <a href="{{ route('setting.create') }}" class="btn btn-primary margin-bottom">{{__('_basic.setting-create')}}</a>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{__('_basic.setting-index')}}</h3>
            <div class="box-tools">
                <form method="get">
