...
@section('title') Zero|CMS - {{__('_basic.role-edit')}} @stop
@section('content')
                ...
                <div class="tab-pane active" id="tab_1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="display_name" autocomplete="off"
                               value="{{ Input::old('display_name', isset($role) ? $role->display_name : null) }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" cols="45" rows="2" maxlength="200"
                                  ...
                                  autocomplete="off">{{ Input::old('description', isset($role) ? $role->description : null) }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>关联权限
                            <small class="text-red">*</small>
                        ...
                        <div class="input-group">
                            @foreach($permissions as $per)
                                <input type="checkbox" name="permissions[]"
                                       value="{{ $per->id }}" {{ in_array($per->id,$canPermissions) ? 'checked' : '' }}>
