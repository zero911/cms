    ...
    <section class="sidebar" style="height: auto;">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu" style="display: none;">
                    <li><a href="http://g.yascmf.cn/admin/system_option"><i class="fa fa-square-o"></i>系统配置</a></li>
                    <li><a href="http://g.yascmf.cn/admin/setting_type"><i class="fa fa-square-o"></i>动态设置分组</a></li>
                    <li><a href="http://g.yascmf.cn/admin/setting"><i class="fa fa-square-o"></i>动态设置</a></li>
