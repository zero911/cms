...
/*    public function __construct(Request $request)
    {
        ...
        $this->aCustomConditionArray=['id'=>['in',$aPermissionIds]];
    ...
    public function beforeRender()
    {
        ...
        $this->setVars('types',$sModel::getTypes());
    }
...
//        pr($oArticle);exit;
    ...
    public function setAdminPermission($role_id){
        echo 1;die;
    }

    public function viewAdminPermission($role_id){
        echo 2;die;
    }
    /** [删除]
     * @param null $ids
